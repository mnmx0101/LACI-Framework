...
To provide a structured, auditable process for determining whether and how model-generated o)utputs can support IPC Current Analysis, Projection Analysis, and Risk Monitoring. LACI is *not* a general certification system for all models, nor is it a replacement for IPC analyst judgment. Instead, it operationalizes model outputs as rigorous, complementary evidence.
...
To operationalize the **Learn** and **Assess** steps, LACI relies on three primary operational tools. These templates guide model builders, DIT reviewers, and analysts through the evaluation process.

### The Templates

* [LACI Learn Card Template](file:///c:/Users/ck24/OneDrive%20-%20Johns%20Hopkins/IPC/LACI/.codex_review/LACI_Consolidated_v1/LACI_Learn_Card_Template.md): A descriptive metadata sheet cataloging the model, its outputs, training data, and an initial mapping to potential IPC applications.
* [LACI Assess Card Template](file:///c:/Users/ck24/OneDrive%20-%20Johns%20Hopkins/IPC/LACI/.codex_review/LACI_Consolidated_v1/LACI_Assess_Card_Template.md): Technical evaluation of model soundness and time-relevance. Now includes context-specific limitations.
...
* **[Sample Learn Card (Yemen)](file:///c:/Users/ck24/OneDrive%20-%20Johns%20Hopkins/IPC/LACI/.codex_review/LACI_Consolidated_v1/LACI_Learn_Card_Yemen_Datadriven.md)**: Documents the model's reliance on price shocks, conflict data, and drought (SPI) to trigger binary early warnings.
* **[Sample Assess Card (Yemen)](file:///c:/Users/ck24/OneDrive%20-%20Johns%20Hopkins/IPC/LACI/.codex_review/LACI_Consolidated_v1/LACI_Assess_Card_Yemen_Sample.md)**: Assesses the methodology (GLM with Recursive Feature Elimination) and explicitly flags the risk that the model's output ("Population in Phase 4+") could be misinterpreted as a direct, endorsed IPC classification without proper guardrails. Includes context-specific limitations addressing IRG/AA geographic data divides.
